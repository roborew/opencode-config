...
feature:
  ...
  tickets:
    - { issue: <n>, title: <t>, branch: opencode/ticket-<n>-<slug>-<abbrev>, worktree_directory: <dir>, session_id: <id>, kickoff: admitted|failed, bind_failed: <bool>, session_source: reused|created, resolution: reused|created }
```
