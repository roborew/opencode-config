...
3. As soon as the task no longer requires senior-dev (blocker fixed, remaining work straightforward), report `HANDOFF_TO_DEVELOPER` and return to the coder session so it can resume with developer.
