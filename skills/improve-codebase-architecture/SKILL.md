...
- If the model is not `opencode/gpt-5.6-terra` or an explicitly approved fallback, report `MODEL_UNAVAILABLE: opencode/gpt-5.6-terra` to the parent before doing heavy synthesis.
