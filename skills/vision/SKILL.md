---
name: vision
description: "Use when the model needs to see the UI. Image/layout reviewer for screenshots. Invoked by orchestrate only when developer, frontend-dev, or code-review explicitly request image review—not on every test run."
modelTier: "smart"
