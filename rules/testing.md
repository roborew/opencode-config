...
- When preflight/skill reports `sandbox: ready` and the repo documents compose tests, verifier may accept `sandbox exec` logs as equivalent evidence to local test runners.
